<template>
  ...
  >
    ...
    <div>
              ...
              <h3 class="font-medium leading-snug text-slate-200">
                <div>
                  ...
                  >
                    ...
                    ></span>
                    <div>
                      <span class="block mb-1"> Fullstack Web Developer </span>
                      <span class="block text-slate-500 text-sm">Brevonic</span>
                    </div>
                  </div>
                </div>
              </h3>
                  ...
                  >
                    ...
                    <div>
                      <span class="block mb-1">
                        Fullstack Web Developer & Lead UI/UX Designer
                      </span>
                      <span class="block text-slate-500 text-sm"
                        >Brightprice Corporation</span
                      >
                    </div>
                  </div>
                </div>
              ...
              <h3 class="font-medium leading-snug text-slate-200">
                <div>
                  ...
                  >
                    ...
                    <div>
                      <span class="block mb-1">
                        Microcontroller Developer/Engineer
                      </span>
                      <span class="block text-slate-500 text-sm"
                        >Freelance</span
                      >
      ...
      <div class="mt-12">
        <a
          class="inline-flex items-baseline font-semibold leading-tight text-slate-200 hover:text-teal-300 focus-visible:text-teal-300 group/link text-base"
          href="https://drive.google.com/file/d/103nd_fXVPPCNruX8TQHI1Xw4qQkFC4Dm/view?usp=sharing"
          target="_blank"
