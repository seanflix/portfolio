<template>
    <!-- <div class="w-full border-b border-sky-500/20 p-7 fixed top-0 z-50 bg-gradient-to-b from-black to-transparent">
        <div class="max-w-7xl mx-auto flex items-center justify-between">
            <div class="flex items-center space-x-4">
                <img src="../assets/seanflix.png" class="h-7" alt="">
            </div>
            <ul class="flex items-center space-x-10 text-sm">
                <li>
                    <button class="tracking-widest font-light uppercase cursor-pointer hover:text-sky-400">About</button>
                </li>
                <li>
                    <button class="tracking-widest font-light uppercase cursor-pointer hover:text-sky-400">Services</button>
                </li>
                <li>
                    <button class="tracking-widest font-light uppercase cursor-pointer hover:text-sky-400">Portfolio</button>
                </li>
                <li>
                    <button class="tracking-widest font-light uppercase cursor-pointer hover:text-sky-400">Work</button>
                </li>
                <li>
                    <button class="tracking-widest font-light uppercase cursor-pointer hover:text-sky-400">Testimonials</button>
                </li>
                <li>
                    <button class="tracking-widest font-light uppercase cursor-pointer hover:text-sky-400">Contact</button>
                </li>
            </ul>
        </div>
    </div> -->
